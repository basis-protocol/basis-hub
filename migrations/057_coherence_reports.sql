-- Migration 057: Coherence reports table for cross-domain consistency validation
...
INSERT INTO migrations (name) VALUES ('057_coherence_reports') ON CONFLICT DO NOTHING;
