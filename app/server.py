...
def _render_rankings_html() -> str:
    ...
    json_ld = {
        ...
        "description": "Standardized risk scores for on-chain stablecoins. SII scores 23 components across 5 categories with 28 diagnostic signals.",
...
<head>
    ...
    <meta name="description" content="Standardized risk scores for {count} on-chain stablecoins. Updated hourly. 23 scoring components, 28 diagnostic signals, 4 live data sources.">
