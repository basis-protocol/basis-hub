...
from app.database import fetch_all, execute, get_cursor, fetch_one_async, fetch_all_async, execute_async
...
BLOCKSCOUT_CHAINS = {
    "ethereum": {
        ...
        "budget": 25_000,  # 100K shared across all chains. 25K each + 25K headroom
    },
    "base": {
