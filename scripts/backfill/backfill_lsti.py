...
from app.index_definitions.lsti_v01 import LST_ENTITIES, LSTI_V01_DEFINITION
...
async def backfill_entity(entity: dict, days_back: int = 365):
    ...
    while current <= end_date:
        ...
        # path (lst_collector.score_lst → score_entity → app.composition.aggregate).
            ...
            execute(
                ...
                INSERT INTO generic_index_scores
                    (index_id, entity_slug, entity_name, overall_score, raw_values,
                     component_scores, category_scores, formula_version, scored_date,
                ...
                (INDEX_ID, slug, name, result["overall_score"],
                 ...
                 json.dumps(LSTI_V01_DEFINITION.get("aggregation", {}).get("params", {})),
